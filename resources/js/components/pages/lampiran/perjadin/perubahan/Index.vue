        ...
        <template slot-scope="scope">
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a v-if="scope.item.status == 1  && user != 'Supervisor'" @click="onCancel({ id: scope.item.id, index: scope.index })" class="icon"><i class="fe fe-x text-danger"></i></a>
                    ...
                    <a v-if="scope.item.status <= 0  && user != 'Supervisor'" @click="set_form({ id: scope.item.id }); jump({ name:'lampiran-perjadin-perubahan-edit' })" class="icon"><i class="fe fe-edit text-secondary"></i></a>
...
export default {
    ...
    methods: {
        ...mapActions({
            ...
            'set_splice': 'setters/non-api/lampiran/perjadin/splice',
        ...
        onDelete(args){
            this.onDeleteConfirmation({
                url: 'lampiran/perjadin/perubahan/'+args.id,
                id: args.id,
                bundle: args
            })       
        },             
    ...
    data() {
        return {
            ...
            judul: 'Data Perubahan Perjalan Dinas',
