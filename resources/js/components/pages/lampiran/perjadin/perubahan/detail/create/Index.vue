<template>
    <div>
        <Toolbar judul="Create Pegawai Perjadin" slot="title">
        ...
        <Formulir column_content="col-12">
            ...
            <FormulirLegend slot="legend" title="Create Pegawai Perjadin" />
    ...
    methods: {
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('lampiran/perjadin/'+id+'/detail/create').then((response) => {
        ...
        onSubmit(){
          ...
          const payload = { pegawai_id }

          const request = new Promise((resolve, reject) => {
              axios.post('lampiran/perjadin/'+id+'/detail/create', payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
