<template>
    <div>
        <Toolbar judul="Create Detail Honor" slot="title">
        ...
        <Formulir>
            <FormulirLegend slot="legend" title="Create Detail Honor" />
    ...
    methods: {
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('lampiran/honor/'+id+'/detail/create').then((response) => {
        ...
        onSubmit(){
          ...
          const payload = { pegawai_id, jumlah, satuan, volume }

          const request = new Promise((resolve, reject) => {
              axios.post('lampiran/honor/'+id+'/detail/create', payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
