<template>
    <div>
        <Toolbar judul="Edit Honor" slot="title">
        ...
        <Formulir column_content="col-12">
            ...
            <FormulirLegend slot="legend" title="Edit Honor" />
    ...
    methods: {
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('lampiran/honor/'+id+'/edit?kode_dpa='+this.get_form.kode_dpa).then((response) => {
        ...
        onSubmit(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.put('lampiran/honor/'+id+'/edit', payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
