              ...
              <div class="card-body">
                ...
                <FormulirDropdown slot="input" title="Jenis Kelamin">
                    <div slot="default" class="input-group">
                        <select class="form-control custom-select submit-on-change" name="jenis_kelamin" id="jenis_kelamin">
                ...
                <FormulirDropdown slot="input" title="Pendidikan">
                    <div slot="default" class="input-group">
                        <select class="form-control custom-select submit-on-change" name="pendidikan" id="pendidikan">
                ...
                <FormulirDropdown 
                    ...
                    title="Bidang">
                      <div slot="default" class="input-group">
                        <select name="bidang_id" id="bidang_id" class="form-control selectize submit-on-change">
          ...
          <div class="col-md-12 col-lg-4 mb-5">
            <div class="card h-100">
              ...
              <div class="card-body">
                ...
                <FormulirDropdown slot="input" title="Honor">
                    <div slot="default" class="input-group">
                        <select class="form-control custom-select submit-on-change" name="honor_id" id="honor_id">
    ...
    methods: {
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('data-dasar/pegawai/create').then((response) => {
        ...
        onSubmit(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.post('data-dasar/pegawai', payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
