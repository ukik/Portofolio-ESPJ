<template>
    <div>
        <Toolbar judul="Edit Data Dasar Pimpinan" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Edit Data Dasar Pimpinan" />
...
export default {
    computed: {
        ...mapGetters({
            'get_listPegawai': 'getters/data-dasar/pimpinan/listPegawai',
            'get_form': 'getters/data-dasar/pimpinan/form',
        }),
    },
    methods: {
        ...mapActions({
            'set_listPegawai': 'setters/api/data-dasar/pimpinan/listPegawai',            
        }),    
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('data-dasar/pimpinan/'+id+'/edit').then((response) => {
        ...
        onSubmit(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.put('data-dasar/pimpinan/'+id, payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
