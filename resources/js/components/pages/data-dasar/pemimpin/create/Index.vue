<template>
    <div>
        <Toolbar judul="Creat Data Dasar Pimpinan" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Creat Data Dasar Pimpinan" />
    ...
    methods: {
      ...
      onInitData(){
        ...
        const request = new Promise((resolve, reject) => {
            axios.get('data-dasar/pimpinan/create').then((response) => {
      ...
      onSubmit() {
        ...
        const request = new Promise((resolve, reject) => {
            axios.post('data-dasar/pimpinan', payload).then((response) => {
                resolve(response)
            }).catch((error) => {
                reject(error);
            })
