<template>
    <div>
        <Toolbar judul="Edit Data Dasar PPTK" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Edit Data Dasar PPTK" />
...
export default {
    computed: {
        ...mapGetters({
            ...
            'get_form': 'getters/data-dasar/pptk/form',
        }),     
    },
    methods: {
        ...mapActions({
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('data-dasar/pptk/'+id+'/edit').then((response) => {
        ...
        onSubmit(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.put('data-dasar/pptk/'+id, payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
