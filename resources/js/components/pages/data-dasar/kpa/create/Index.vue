<template>
    <div>
        <Toolbar judul="Creat Data Dasar KPA" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Creat Data Dasar KPA" />
    ...
    methods: {
      ...
      onInitData(){
        ...
        const request = new Promise((resolve, reject) => {
            axios.get('data-dasar/kpa/create').then((response) => {
      ...
      onSubmit() {
        ...
        const request = new Promise((resolve, reject) => {
          axios.post('data-dasar/kpa', payload).then((response) => {
              resolve(response)
          }).catch((error) => {
              reject(error);
          })
