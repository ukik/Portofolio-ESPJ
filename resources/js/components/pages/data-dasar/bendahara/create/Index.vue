<template>
  <div>
    <Toolbar judul="Creat Data Dasar Bendahara" slot="title">
    ...
    <Formulir>
      ...
      <FormulirLegend slot="legend" title="Creat Data Dasar Bendahara" />
    ...
    methods: {
      ...
      onInitData(){
        ...
        const request = new Promise((resolve, reject) => {
            axios.get('data-dasar/bendahara/create').then((response) => {
      ...
      onSubmit() {
        ...
        const request = new Promise((resolve, reject) => {
          axios.post('data-dasar/bendahara', payload).then((response) => {
              resolve(response)
          }).catch((error) => {
              reject(error);
          })
