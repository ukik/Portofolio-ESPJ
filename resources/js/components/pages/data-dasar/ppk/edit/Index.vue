<template>
    <div>
        <Toolbar judul="Edit Data Dasar PPK-SKPD" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Edit Data Dasar PPK-SKPD" />
...
export default {
    computed: {
        ...mapGetters({
            'get_listPegawai': 'getters/data-dasar/ppk/listPegawai',
            'get_form': 'getters/data-dasar/ppk/form',
        }),
    },
    methods: {
        ...mapActions({
            'set_listPegawai': 'setters/api/data-dasar/ppk/listPegawai',            
        }),    
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('data-dasar/ppk/'+id+'/edit').then((response) => {
        ...
        onSubmit(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.put('data-dasar/ppk/'+id, payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
