<template>
    <div>
        <Toolbar judul="Creat Data Dasar PPK-SKPD" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Creat Data Dasar PPK-SKPD" />
    ...
    methods: {
      ...
      onInitData(){
        ...
        const request = new Promise((resolve, reject) => {
            axios.get('data-dasar/ppk/create').then((response) => {
      ...
      onSubmit() {
        ...
        const request = new Promise((resolve, reject) => {
            axios.post('data-dasar/ppk', payload).then((response) => {
                resolve(response)
            }).catch((error) => {
                reject(error);
            })
