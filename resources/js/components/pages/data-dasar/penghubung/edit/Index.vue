<template>
    <div>
        <Toolbar judul="Edit Data Dasar Penghubung" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Edit Data Dasar Penghubung" />
...
export default {
    computed: {
        ...mapGetters({
            'get_listPegawai': 'getters/data-dasar/penghubung/listPegawai',
            'get_form': 'getters/data-dasar/penghubung/form',
        }),
    },
    methods: {
        ...mapActions({
            'set_listPegawai': 'setters/api/data-dasar/penghubung/listPegawai',            
        }),    
        ...
        onInitData(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.get('data-dasar/penghubung/'+id+'/edit').then((response) => {
        ...
        onSubmit(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.put('data-dasar/penghubung/'+id, payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
