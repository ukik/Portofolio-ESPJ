<template>
    <div>
        <Toolbar judul="Creat Data Dasar Penghubung" slot="title">
        ...
        <Formulir>
            ...
            <FormulirLegend slot="legend" title="Creat Data Dasar Penghubung" />
    ...
    methods: {
      ...
      onInitData(){
        ...
        const request = new Promise((resolve, reject) => {
            axios.get('data-dasar/penghubung/create').then((response) => {
      ...
      onSubmit() {
        ...
        const request = new Promise((resolve, reject) => {
            axios.post('data-dasar/penghubung', payload).then((response) => {
                resolve(response)
            }).catch((error) => {
                reject(error);
            })
