        ...
        <TableView :items="get_spj.data" :theads="theads">
            <template slot-scope="scope">
                <tr>
                    ...
                    <td class="align-middle text-center">{{ undefined_permohonan(scope.item.permohonan) }}</td>
                    ...
                    <td v-verification-info="scope.item.status" class="align-middle text-center" />
                    <td class="text-center">
                        <a
                            @click="set_form({ id: scope.item.id }); jump({ name:'verifikasi-spj-review' })" 
...
export default {
    computed: {
        ...mapGetters({
            'get_spj': 'getters/verifikasi/spj/spj',
        }),
    ...
    methods: {
        ...mapActions({
            'set_spj': 'setters/api/verifikasi/spj/spj',
            'set_form': 'setters/non-api/verifikasi/spj/form',  
        }),
        ...
        onInitData(){
            ...
            const request = new Promise((resolve, reject) => {
                axios.get('verifikasi/spj'+this.suffix).then((response) => {
