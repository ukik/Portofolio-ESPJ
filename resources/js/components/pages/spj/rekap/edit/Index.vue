<template>
    <div>
        <Toolbar judul="Edit Rincian Rekap Pengeluaran SPJ" slot="title">
        ...
        <Formulir column_content="col-12">
            ...
            <FormulirInput readonly="true" 
                ...
                type="text" 
                name="" 
                :value="get_form.permohonan.nominal_disetujui | rupiah2" 
            ...
            <FormulirInput readonly="true" 
                ...
                type="text" 
                name="" 
                :value="get_form.permohonan.nominal_diajukan | rupiah2" 
            ...
            <FormulirInput readonly="true" 
                ...
                type="text" 
                name="" 
                :value="(get_form.permohonan.nominal_diajukan - get_form.permohonan.nominal_disetujui) | rupiah2" 
            ...
            <FormulirInput 
                ...
                type="number" 
                name="nominal" 
                :value="get_form_2.nominal" 
                placeholder="Nominal (Rp)" 
                title="Nominal (Rp)" />

            <div v-if="pageReady && !pageUpdate" slot="input" class="form-group">
                ...
                <div class="custom-controls-stacked">
                    ...
                    <input 
                        ...
                        ref="ppn"
                        id="ppn"
                        v-checked="$store.state.spj_rekap.form.ppn_persen > 0"
                        :value="valued('ppn')">
                    ...
                    <input 
                        ...
                        id="pph21" 
                        ref="pph21"
                        v-checked="$store.state.spj_rekap.form.pph_21_persen > 0"
                        :value="valued('pph21')">
                    ...
                    <input 
                        ...
                        id="pph22" 
                        ref="pph22"
                        v-checked="$store.state.spj_rekap.form.pph_22_persen > 0"
                        :value="valued('pph22')">
                    ...
                    <input 
                        ...
                        id="pph23" 
                        ref="pph23"
                        v-checked="$store.state.spj_rekap.form.pph_23_persen > 0"
                        :value="valued('pph23')">
...
export default {
    computed: {
        ...mapGetters({
            ...
            'get_form_2': 'getters/spj/rekap/form',
        }),
        valued () {
            return (args) => {
    ...
    methods: {
        ...
        onInitData(){
          ...
          const id_rekap = this.get_form_2.id

          // sesuaikan dengan kebutuhan bisnis page ini
          const request = new Promise((resolve, reject) => {
              axios.get('spj/'+id+'/rekap/'+id_rekap+'/edit').then((response) => {
        ...
        onSubmit(){
            ...
            const request = new Promise((resolve, reject) => {
                axios.put('spj/'+id+'/rekap/'+id_rekap, payload).then((response) => {
        ...
        AutocompleteRekening(args){
            new Promise((resolve) => {
                args.forEach(element => {
                    ...
                    if(element.kode_rekening == this.get_form_2.kode_rekening) {
                ...
                this.pageReady = true
                this.kode_rekening = this.get_form_2.kode_rekening
            })
    ...
    mounted() {
        ...
        this.$nextTick(() => {
            this.bukti_tanggal = this.get_form_2.tanggal 
            this.uraian = this.get_form_2.uraian
            this.kode_dpa = this.get_form_2.kode_dpa
        })
    },
    data() {
        ...
        return {
            ...
            month,
            day,
            bukti_tanggal: null, // untuk store vue-datetime
        }
    }
}
