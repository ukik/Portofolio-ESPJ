...
export default {
    ...
    methods: {
        ...
        onInitData(){
            ...
            const request = new Promise((resolve, reject) => {
                axios.get('standar/hotel/luar/'+id+'/edit').then((response) => {
        ...
        onSubmit(){
          ...
          const request = new Promise((resolve, reject) => {
              axios.put('standar/hotel/luar/'+id, payload).then((response) => {
                  resolve(response)
              }).catch((error) => {
                  reject(error);
              })
    ...
    data() {
      return {
          nominal: this.$store.state.standar_perjadin_hotel_luar_wilayah.form.nominal,
          theads: [
              {
                  title: 'No',
                  width: '',
