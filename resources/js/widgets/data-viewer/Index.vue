<template>
    <div>
       ...
       <div class="panel-heading" style="padding: 10px 0px 15px 0px">
            <div>
                <button class="btn btn-default btn-sm" @click="showFilter = !showFilter">Filter</button>
                <button class="btn btn-default btn-sm" @click="onPrint()">Print</button>
            </div>
        </div>
            ...
            <div class="filter" v-if="showFilter">
                <div class="filter-column">
                    <select class="form-control" v-model="params.search_column">
                        <option v-for="(column, index) in filter" :value="column" :key="index">{{alias[index]}}</option>
                    </select>
                </div>
                ...
                <div class="filter-btn">
                    <button class="btn btn-primary btn-sm btn-block" @click="fetchData">Cari</button>
                </div>
            </div>
                ...
                <table class="table table-bordered table-hover table-xs bg-white">
                    <thead class="text-center">
                        <tr class="bg-primary text-light">
                            <th v-for="item in thead" :key="item.key" class="align-middle text-light">
                    ...
                    <tfoot>
                        <slot name="tfoot" :length="items_length" :items="model.data"/>
                    </tfoot>
                </table>
            </div>

        <div class="panel-footer pagination-footer" style="margin-bottom: 15px;">
...
<script>
    export default {
            ...
            fetchData() {
                ...
                axios.get(this.buildURL())
                    .then(function(response) {
                        Vue.set(vm.$data, 'model', response.data.data.data)

                        vm.$store.dispatch('setters/'+vm.store+'/model', response.data.data.data)
                    })
        ...
        beforeMount() {
            this.model = this.$store.state['rekap_'+this.store].model 
            this.fetchData();
        },
    }
</script>
...
@media print
{
  ...
  #print { position: absolute; top: 50px; left: 0; }
}
